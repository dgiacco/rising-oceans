...
const CampaignForm = () => {
  ...
  const formInput =
    "mt-1 p-2 bg-roAquaBlue/20 border border-2 border-roSeaGreen rounded-lg w-full text-roAquaBlue font-bold min-h-[46px]";
  const targetInput =
    "mt-1 p-2 bg-roAquaBlue/20 border border-2 rounded-lg w-full font-bold min-h-[46px]";
